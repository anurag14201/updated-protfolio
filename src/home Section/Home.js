    ...
    return (
        <div>
            <div className='text-start pt-32 m-12'>
                ...
                <br></br>
                <h1 className='text-5xl font-bold	'>A Software Engineer. I write your <span className='font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"'>Ideas</span> in <span className='font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"'>Codes</span></h1>
                <h1 className='text-xl m-5 font-small '>I create beautiful & functional websites for small businesses. Below are a few service i provide.</h1>
            </div>
