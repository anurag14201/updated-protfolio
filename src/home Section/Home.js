    ...
    return (
        <div>
            <div className='text-start pt-24 m-24' data-aos="fade-up">
                ...
                <br></br>
                <h1 className='text-5xl font-bold text-gray-700'>A Software Engineer and a Full stack Web developer. I write your <span className='font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"'>Ideas</span> in <span className='font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"'>Codes</span></h1>
